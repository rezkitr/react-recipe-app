    ...
    return (
      <React.Fragment>
        <div className="col-10 mx-auto col-md-6 col-lg-4 my-3">
          <div className="card">
            <img src={image_url} alt="img" className="img-card-top"
              style={{ height: "14rem" }} />
            ...
            <div className="card-footer">
              <button onClick={() => handleDetails(0, recipe_id)} type="button" className="btn btn-primary text-capitalize" >details</button>
