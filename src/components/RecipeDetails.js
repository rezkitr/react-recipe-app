...
export default class RecipeDetails extends Component {
  ...
  //   this.state = {
  //     recipe: recipe,
  //     url: `https://www.food2fork.com/api/get?key=45b72a2fb0193159d238981622552213&rId=${this.props.id}`
  //   }
  // }
  ...
  async componentDidMount() {
    ...
    const url = `https://www.food2fork.com/api/get?key=45b72a2fb0193159d238981622552213&rId=${id}`
    try {
